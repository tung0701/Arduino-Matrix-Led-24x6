...
//#define BC {B11111000,B10000000,B10000000,B10000000,B10000000,B11111000}  // Previous Big C
#define BD {B11110000,B10001000,B10001000,B10001000,B10001000,B11110000}

#define BE {B11110000,B10000000,B11110000,B10000000,B10000000,B11110000}

//#define BE {B11111000,B10000000,B10000000,B11110000,B10000000,B11111000}  // Previous E
...
#define BL {B10000000,B10000000,B10000000,B10000000,B10000000,B11110000}
...
#define COMMA{B00000000,B00000000,B00000000,B00110000,B00110000,B01100000}
...
#define EXCLAMATION{B00100000,B00100000,B00100000,B00100000,B00000000,B00100000}
#define HEART {B00000000,B11011000,B11111000,B01110000,B00100000,B00000000}


/*User configuration defines */
#define NOOFWORDS 168
...
byte your_text[][6]={HEART,SPACE,SPACE,SPACE,SPACE,SPACE,BH,BA,BP,BP,BY,SPACE,  //HAPPY
                     BB,BI,BR,BT,BH,BD,BA,BY,SPACE, //BIRTHDAY
                     BT,BO,SPACE,BM,BY,SPACE,BS,BP,BE,BC,BI,BA,BL,SPACE,BB,BA,BB,BE,COMMA,SPACE,  //TO MY SPECIAL BAE
                     BV,BA,BN,SPACE,BT,BH,BA,BN,BH,EXCLAMATION,SPACE, // VAN THANH !
                     BT,BH,BI,BS,SPACE,BI,BS,SPACE,BY,BO,BU,BR,SPACE,BM,BO,BM,BE,BN,BT,COMMA,SPACE, // THIS IS YOUR MOMENT ,
                     BS,BO,SPACE,BH,BA,BV,BE,SPACE,BA,SPACE,BF,BA,BN,BT,BA,BS,BT,BI,BC,SPACE,BD,BA,BY,COMMA,SPACE,  //SO HAVE A FANTASTIC DAY
                     BM,BA,BK,BE,SPACE,BY,BO,BU,BR,SPACE,BB,BI,BR,BT,BH,BD,BA,BY,SPACE,BW,BI,BS,BH,COMMA,SPACE, //, MAKE YOUR BIRTHDAY WISH,
                     BA,BN,BD,SPACE,BL,BE,BT,SPACE,BI,BT,SPACE,BF,BL,BY,SPACE,BH,BI,BH,BG,BH,BE,BR,EXCLAMATION,SPACE, // AND LET IT FLY HIGHER !
                     BI,SPACE,BL,BO,BV,BE,SPACE,BY,BO,BU,SPACE,BB,BA,BE,SPACE,HEART,HEART,HEART,HEART,HEART,HEART};//LOVING YOU BAE 
...
byte make_word (long posistion,byte turn){
  ...
  void loop() {
        ...
        display_word(1,your_text,NOOFWORDS,SCROLLSPEED);// calls for the display_pattern function and says that int loop = 15(if you do more loop the pattern whould scrole slower).
